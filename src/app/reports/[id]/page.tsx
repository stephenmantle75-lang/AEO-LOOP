...
export default async function ReportDetailPage({ params }: Props) {
  ...
  return <ObservatoryShell active="runs" findingCount={findingCount}>
    ...
    <div className="notice">This report is a derived review artifact — viewing it never re-sends anything. Slack delivery is live (see Delivery above); Zapier and Linear issue creation are not connected yet.</div>
  </ObservatoryShell>;
}
