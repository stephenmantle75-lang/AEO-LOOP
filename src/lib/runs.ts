...
export type Run = { id: string; run_key: string; status: string; started_at: string; completed_at?: string | null; duration_ms?: number | null; cost_usd?: number | null; sources: string[]; metadata: Record<string, unknown> };
